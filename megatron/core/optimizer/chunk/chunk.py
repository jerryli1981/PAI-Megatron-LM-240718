...
class Chunk:
    ...
    def __init__(
        ...
        NOTE: This module is borrowed from [ColossalAI](https://github.com/hpcaitech/ColossalAI/blob/main/colossalai/zero/gemini/chunk/chunk.py).
        And we remove useless feature for sync between processes.
